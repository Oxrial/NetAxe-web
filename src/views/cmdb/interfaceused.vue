    ...
    <TableBody>
      ...
      <template #default>
        ...
        <n-space style="float: right; padding-bottom: 20px">
          ...
          <n-button style="float: right" size="small" type="warning" @click="chart_show = true">运营数据展示 </n-button>
        </n-space>
      ...
      useTableColumn(
        [
          ...
          },
          {
            ...
            key: 'int_used_100g',
            render(rowData) {
              return (rowData.int_used_100g ? rowData.int_used_100g : 0) + '/' + (rowData.int_used_100g + rowData.int_unused_100g)
            }
          },
          {
            title: '10M',
          ...
          },
          {
            ...
            key: 'int_used_100m',
            render(rowData) {
              return (rowData.int_used_100m ? rowData.int_used_100m : 0) + '/' + (rowData.int_used_100m + rowData.int_unused_100m)
            }
          },
          {
            title: '已使用',
